...
def apply_yolo_object_detection(image_to_process):
    ...
    # outs - это наши коробки, здесь хранится не просто объект, а массив вероятностей того, какое это изображение
    class_indexes, class_scores, boxes = ([] for i in range(3))
    objects_count = 0

    # boxes - хранит координаты объектов
    # массивы classes_ - определяют тип объектов
...
if __name__ == '__main__':
    ...
    # Result/input/VID_20220107_202624.mp4
